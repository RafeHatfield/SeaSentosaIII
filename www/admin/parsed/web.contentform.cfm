...
<cfset qOtherContentImages = application.imageObj.getContentImages(con_id=attributes.con_id,excludeType='Main,Header') >
<cfset qHeaderImages = application.imageObj.getContentImages(con_id=attributes.con_id,excludeType='Main,Content') >
<cfset qGalleries = application.imageObj.getGalleries(gal_type='Content') >
...
<cfset attributes.con_gallery = "#qContent.con_gallery#" />
<cfset attributes.con_background = "#qContent.con_background#" />
...
<cfset attributes.con_gallery = "" />
<cfset attributes.con_background = "" />
