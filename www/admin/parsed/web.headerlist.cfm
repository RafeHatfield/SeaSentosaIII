...
<cfset myFusebox.thisFuseaction = "headerList">
<cfif not isDefined("attributes.hdr_id")><cfset attributes.hdr_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset application.imageObj.HeaderSave(argumentCollection=attributes) >
<cfset attributes.hdr_id = "0" />
</cfif>
<cfset HeaderForm = application.imageObj.displayHeaderForm(attributes.hdr_id) >
<cfset HeaderList = application.imageObj.displayHeaderList() >
<cfset content.mainContent = "#HeaderForm##HeaderList#" />
