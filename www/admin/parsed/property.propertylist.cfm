...
<cfset myFusebox.thisCircuit = "property">
<cfset myFusebox.thisFuseaction = "propertyList">
<cfset xfa.editProperty = "property.propertyForm" />
<cfif not isDefined("attributes.fastFind")><cfset attributes.fastFind = "" /></cfif>
<cfif not isDefined("listingsList")><cfset listingsList = "" /></cfif>
<cfset content.mainContent = application.propertyObj.displayListingSearch(fastFind=attributes.fastFind) >
<cfset listingsList = application.propertyObj.displayListings(argumentCollection=attributes) >
<cfset content.mainContent = "#content.mainContent##listingsList#" />
