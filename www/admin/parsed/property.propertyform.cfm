...
<cfset myFusebox.thisFuseaction = "propertyForm">
<cfif not isDefined("attributes.pro_id")><cfset attributes.pro_id = "0" /></cfif>
<cfif isDefined('attributes.save')>
<cfset attributes.pro_id = application.propertyObj.propertySave(argumentCollection=attributes) >
<cflocation url="#myself#property.propertyList" addtoken="false">
<cfabort>
</cfif>
<cfset propertyForm = application.propertyObj.displayPropertyForm(pro_id=attributes.pro_id) >
<cfif not isDefined("content.mainContent")><cfset content.mainContent = "#propertyForm#" /></cfif>
